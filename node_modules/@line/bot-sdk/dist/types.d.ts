...
export declare type LINEThingsScenarioExecutionEvent = {
    events: Array<LINEThingsEvent>;
    destination: string;
};
export declare type LINEThingsEvent = ReplyableEvent & {
    type: "things";
    things: {
        type: "scenarioResult";
        /**
...
export declare type NumberOfSentBroadcastMessages = {
    /**
     * Status of the counting process. One of the following values is returned:
     *  - `ready`: You can get the number of messages.
     *  - `unready`: The message counting process for the date specified in date has not been completed yet.
